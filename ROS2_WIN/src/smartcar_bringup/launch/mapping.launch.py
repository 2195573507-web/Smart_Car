"""Measured-sensor gated live mapping workflow."""
...
def generate_launch_description():
    ...
    slam_params = PathJoinSubstitution([FindPackageShare("smartcar_bringup"), "config", "p1_mapping.yaml"])
    ...
    return LaunchDescription([
        ...
        Node(package="slam_toolbox", executable="async_slam_toolbox_node", name="slam_toolbox",
             output="screen", parameters=[slam_params, {"use_sim_time": ParameterValue(use_sim_time, value_type=bool)}]),
        ExecuteProcess(cmd=["ros2", "bag", "record", "-o", LaunchConfiguration("bag_uri"),
