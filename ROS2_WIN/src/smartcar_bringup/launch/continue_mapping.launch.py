"""Continue mapping from a slam_toolbox posegraph, or start a fresh map."""
...
def generate_launch_description():
    ...
    return LaunchDescription([
        ...
        DeclareLaunchArgument(
            ...
            description="Existing posegraph prefix; leave empty for a new map",
        ),
        DeclareLaunchArgument(
        ...
        DeclareLaunchArgument(
            ...
            description="Start at the first serialized node instead of the given pose",
        ),
