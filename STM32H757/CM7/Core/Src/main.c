...
/* This image is CM7-only; do not wait for or release a CM4 image. */
...
static void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin : STM_RX_NO_UART_RX_AF_Pin */
  GPIO_InitStruct.Pin = STM_RX_NO_UART_RX_AF_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(STM_RX_NO_UART_RX_AF_GPIO_Port, &GPIO_InitStruct);

  /*Configure GPIO pin : STM_TX_NO_UART_TX_AF_Pin */
  GPIO_InitStruct.Pin = STM_TX_NO_UART_TX_AF_Pin;
