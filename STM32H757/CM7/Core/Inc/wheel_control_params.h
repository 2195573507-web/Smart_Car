...
/* 平稳型 PI(D) 控制器比例、积分和微分增益；微分默认关闭。 */
#define WHEEL_PID_KP 1.10f
#define WHEEL_PID_KI 0.060f
#define WHEEL_PID_KD 0.00f

/* Per-wheel output scale for manufacturing tolerance compensation.
