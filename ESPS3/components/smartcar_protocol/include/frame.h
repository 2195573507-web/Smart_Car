#ifndef SMARTCAR_FRAME_H
#define SMARTCAR_FRAME_H
...
#define SC_FRAME_MAX_PAYLOAD 128U
#define SC_FRAME_OVERHEAD 8U
#define SC_FRAME_MAX_SIZE (SC_FRAME_OVERHEAD + SC_FRAME_MAX_PAYLOAD)

/* AA 55 | VERSION | TYPE | LENGTH LE16 | PAYLOAD | CRC16-MODBUS LE. */
/* CRC covers VERSION through PAYLOAD; logs use SC_TYPE_LOG when enabled. */
...
#define CAL_ACK_OK 0x00
#define CAL_ACK_ERROR 0x01
