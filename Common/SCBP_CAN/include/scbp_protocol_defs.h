...
#define SCBP_MSG_ID_WHEEL_SPEED_CMD UINT16_C(0x110)
#define SCBP_MSG_ID_PID_PARAMS_CMD UINT16_C(0x111)
#define SCBP_MSG_ID_POWER_STATUS UINT16_C(0x209)
#define SCBP_MSG_ID_WHEEL_SPEED_STATUS UINT16_C(0x210)
...
#define SCBP_PAYLOAD_WHEEL_SPEED_CMD_SIZE UINT16_C(16)
#define SCBP_PAYLOAD_PID_PARAMS_SIZE UINT16_C(16)
#define SCBP_PAYLOAD_WHEEL_SPEED_STATUS_SIZE UINT16_C(16)
#define SCBP_PAYLOAD_POWER_STATUS_SIZE UINT16_C(4)
...
/* Runtime PID admission limits shared by the App, gateway, and CM7. */
#define SCBP_PID_KP_MIN 0.0f
#define SCBP_PID_KP_MAX 4.0f
#define SCBP_PID_KI_MIN 0.0f
#define SCBP_PID_KI_MAX 0.3f
#define SCBP_PID_KD_MIN 0.0f
#define SCBP_PID_KD_MAX 0.1f
#define SCBP_PID_ACCEL_MIN 200.0f
#define SCBP_PID_ACCEL_MAX 2000.0f
